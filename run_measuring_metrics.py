...
if __name__ == "__main__":
    path_gen_csv = '/home/user/PycharmProjects/SmilesTuneMistral/language_models/llama3-8/result_llama_tune_v7_clean.csv'
    path_try_txt = "/home/user/PycharmProjects/SmilesTuneMistral/data/chembl_alpaca.txt"

    with open('/home/user/PycharmProjects/SmilesTuneMistral/language_models/llama3-8/result_llama_tune_v7_clean.txt') as f:
