...
from xlstm.experiments.data.formal_language.formal_language_dataset import (
    FormLangDatasetGenerator,
)
from xlstm.experiments.data.utils import DataGen
...
if __name__ == "__main__":
    ...
    with open("/data/alina_files/projects/SmilesTuneLLM/xlstm/experiments/parity_xlstm10.yaml", "r", encoding="utf8") as fp:
        config_yaml = fp.read()
