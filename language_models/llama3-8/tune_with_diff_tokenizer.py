...
dataset = load_dataset("csv", data_files=[r"/home/user/PycharmProjects/SmilesTuneMistral/data/chembl_alpaca.txt"], split = "train")
...
inputs = tokenizer([BOS_TOKEN], return_token_type_ids=False, return_tensors="pt").to("cuda")
...
for t in temperatures:
    gens = []
    for i in range(1):
        out = trainer.model.generate(input_ids=inputs['input_ids'], max_new_tokens=64, use_cache=True, temperature=t)
